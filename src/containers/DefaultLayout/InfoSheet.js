                  ...
                  <Col lg='6' xs='6'  className='pl-4 pr-3'>
                    ...
                    <Row className='pb-0 mb-0'>
                      ...
                      <Col md='3' className='text-center mt-3'>
                        ...
                        <Input type='file' className='inputhere' value={this.state.img} onChange={this.onChange}/>
                      </Col>
                    </Row>
                    {/*Sex and Birthday */}
                    <Row className='mt-1'>
                      <Col md='3'>
                        <FormGroup check inline>
                          <Input className="form-check-input" type="radio" id="inline-radio1" name="sex" value="Male" />
                          <Label className="form-check-label" check htmlFor="inline-radio1">Male</Label>
                        </FormGroup>
                        <FormGroup check inline>
                          <Input className="form-check-input" type="radio" id="inline-radio2" name="sex" value="Female" />
